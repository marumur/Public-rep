try: #проверка корректности введенных данных
    array = list(map(float, input("Введите последовательность чисел в любом порядке, через пробел: ").split())) #ввод последовательности чисел
    ...
    def binary_search(array, element, left, right):
        ...
        if array[middle] >= element and array[middle-1] < element: # если элемент в середине,
            return middle-1 # возвращаем этот индекс предыдущего элемента 
